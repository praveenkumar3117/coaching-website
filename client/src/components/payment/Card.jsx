      ...
      <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-2">
          ...
          <div class="px-5 pb-5">
              ...
              <div class="flex items-center justify-between">
                  ...
                  <button class="text-white bg-blue-700 hover:bg-blue-800 shadow-lg active:shadow-md focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={()=>checkoutHandler(amount)}>Buy Now</button>
              </div>
          </div>
      </div>
